...
public class Robot extends TimedRobot {
  ...
  private void initVision() {
    ...
    // try {
    //   CombinedRuntimeLoader.loadLibraries(Robot.class, "wpiutiljni", "wpimathjni", "ntcorejni", "cscorejnicvstatic");
    // }catch(IOException e) {System.out.println("Rip load libraries failed")}
    ...
    System.out.println("init network tables");

    // inst.startClient4("java client");
    // inst.setServer("10.65.93.10");
    // inst.startDSClient();

    System.out.println("end roboto init");
  }
 ...
 // temp netword tables test, comment out eventually - ere
